...
#include <motor_control/TestLib.cpp>
#include <iostream>
#include <vector>
#include <motor_control/SparkFunAutoDriver.cpp>
#include <motor_control/SparkFunAutoDriverCommands.cpp>
#include <motor_control/SparkFunAutoDriverConfig.cpp>
#include <motor_control/SparkFunAutoDriverSupport.cpp>
#include <motor_control/jetsonGPIO.c>
#include <motor_control/linux_spi.cpp>
